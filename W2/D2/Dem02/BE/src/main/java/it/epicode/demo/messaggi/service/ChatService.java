...
import it.epicode.demo.messaggi.repository.MessaggioRepository;
...
public class ChatService {
	...
	/**
	 * Il modo DIFETTOSO, che serve solo a far vedere il guasto della slide 18:
	 * consegna senza salvare. Il messaggio compare nella chat e sparisce al
	 * primo aggiornamento della pagina - e sembra un problema del frontend.
	 */
	public MessaggioRisposta inoltraSenzaSalvare(String mittente, String destinatario, String testo) {
		MessaggioRisposta finto = MessaggioRisposta.finto(mittente, destinatario, testo);
		template.convertAndSendToUser(destinatario, DESTINAZIONE, finto);
		template.convertAndSendToUser(mittente, DESTINAZIONE, finto);
		log.warn("messaggio consegnato SENZA salvataggio da {} a {}: sparira' al ricaricamento",
