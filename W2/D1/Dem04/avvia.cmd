...
echo ============================================
echo  Dem04 - avvio Backend + Frontend
echo ============================================
echo.
...
echo.
rem ---------- PostgreSQL: serve il database W2D1Dem4_Verifica su 5432 ----------
...
if errorlevel 1 (
  ...
  echo            Avvia PostgreSQL e crea il database: W2D1Dem4_Verifica
) else (
  echo [postgres] in ascolto su 5432.
)
echo.
...
start "Dem04 BE (8080)" /D "%~dp0BE" cmd /k .\mvnw.cmd spring-boot:run

rem ---------- Frontend Vite su 5173 ----------
echo [FE] avvio in una nuova finestra...
start "Dem04 FE (5173)" /D "%~dp0FE" cmd /k npm run dev
