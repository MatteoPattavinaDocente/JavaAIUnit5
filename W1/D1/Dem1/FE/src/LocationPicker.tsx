...
// mappa, AdvancedMarker lo spillo, MapMouseEvent il tipo dell'evento di click.
...
// Tipo della libreria (@types/google.maps), non un'interfaccia nostra: "google"
// e' un namespace globale, aggiunto a "types" in tsconfig.app.json.
...
function LocationPicker() {
  ...
  // null significa "nessuna posizione scelta". Il tipo | null va scritto a mano,
  // altrimenti TypeScript deduce solo null e rifiuta setPosizione(coordinate).
  ...
  function handleClick(e: MapMouseEvent) {
    ...
    // L'if serve perche' nei tipi latLng e' opzionale e potrebbe mancare.
    if (e.detail.latLng) {
