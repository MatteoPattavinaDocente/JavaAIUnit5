...
// In TypeScript le due prop erano descritte da un type Props; qui restano solo i
// nomi nella destrutturazione, quindi il contratto va letto in App.jsx.
function LocationPicker({ posizione, onChange }) {
