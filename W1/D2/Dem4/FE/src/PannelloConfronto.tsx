...
import type { Errore, ModoRicezione, Scoperta } from './useNotifiche'
...
type Props = {
  utente: string
  utenti: string[]
  topicSottoscritti: string[]
  modoRicezione: ModoRicezione
  onModoRicezione: (m: ModoRicezione) => void
  richieste: number
  scoperta: Scoperta | null
  errore: Errore | null
  onInviaHttpSenzaPush: (a: string, testo: string) => Promise<void>
  onInviaHttpConPush: (a: string, testo: string) => Promise<void>
  onInviaViaStomp: (a: string, testo: string) => void
  onInviaSuTopic: (topic: string, testo: string) => void
  onControlla: () => Promise<void>
}
