...
import { DESTINAZIONE_PERSONALE, type Arrivo, type Riga } from './useNotifiche'

type Props = {
  utente: string
  destinazioni: string[]
  onAggiungi: (destinazione: string) => void
  onTogli: (destinazione: string) => void
  senzaLogin: boolean
  onSenzaLogin: (valore: boolean) => void
  onPing: (testo: string) => void
  arrivi: Arrivo[]
  righe: Riga[]
  onPulisci: () => void
}
...
const battito = (testo: string) => testo.includes('PING') || testo.includes('PONG')
