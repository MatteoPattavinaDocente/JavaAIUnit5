 ...
 *
 * Il punto della Dem 1: queste sono tutte richieste che parte il BROWSER.
 * Il backend non ha nessun modo di farsi vivo per primo. Se nasce una notifica
 * mentre l'utente guarda la pagina, la pagina non lo sa finche' non richiede.
 */
@RestController
