 ...
 *
 * Identiche alla Dem 1, e non e' un caso: il canale WebSocket non sostituisce il REST,
 * gli si affianca. Il canale porta le novita' in tempo reale; queste chiamate servono
 * per lo storico, per il conteggio all'apertura della pagina e per tutto quello che
 * un utente appena collegato si e' perso mentre era via.
 */
@RestController
