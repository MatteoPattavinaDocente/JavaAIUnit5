...
/**
 * Lo stesso service della Dem 1, con una sola aggiunta: quando nasce una notifica,
 * il service lo ANNUNCIA.
 *
 * Notate cosa NON c'e' in questa classe: nessun import di WebSocket, nessuna sessione,
 * nessuna busta. Il service continua a occuparsi solo del dominio. Il collegamento
 * col canale sta tutto in NotificationListener, che ascolta l'annuncio.
 *
