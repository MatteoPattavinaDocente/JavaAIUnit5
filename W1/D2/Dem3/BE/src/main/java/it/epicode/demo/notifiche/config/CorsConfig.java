 ...
 * per le chiamate REST. L'handshake WebSocket ha una lista sua, dichiarata in
 * WebSocketConfig con setAllowedOrigins. Sono due elenchi separati anche quando
 * contengono lo stesso indirizzo: dimenticarne uno dei due rompe meta' applicazione.
 */
@Configuration
